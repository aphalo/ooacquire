...
functions in the package 'photobiology' are widely useful in photobiology and in
...
The focus of package 'pavo' (Maia et al. 2003) is on colour perception by animals
and assessment of animal colouration. The focus of package 'colorSpec' (Davis
2019) is on colour-related computations: "Calculate with spectral properties of
