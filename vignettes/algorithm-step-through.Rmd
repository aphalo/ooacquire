...
```{r, fig.width=8, fig.asp=0.5}
LED_lamp04_long.raw_spct <-msmsply(LED_lamp04_long.raw_spct, setInstrDesc, MAYP11278_descriptors$cal_2016a)
...
As we can see in the plots above, a small amount of stray light is present in both spectra in the UV region. We apply a filter correction using a simple method based on a fixed transmittance value.
