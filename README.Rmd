...
USB-connected spectrometer. _As support from some older devices has been
...
_The 'ooacquire' package should be installed only after the system requirements
are met by installing drivers and software required at the operating system
level. Please, read carefully the whole installation instructions before
attempting to install this package._
...
3.  Install 'ooacquire' after setting the `repos` option, which
