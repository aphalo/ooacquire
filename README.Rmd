...
are disabled or trigger an error, while other functions will be usable in their
usual way. Thanks to the **off-line** mode, raw data previously acquired with
this package or with software from Ocean Insight can be processed without the
need to install packages **'rOmniDriver'** and **'rJava'** or the **OmniDriver**
drivers from Ocean Insight.
