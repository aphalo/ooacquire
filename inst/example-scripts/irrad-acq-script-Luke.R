...
descriptor <- which_descriptor(descriptors = ooacquire::MAYP114590_descriptors)
...
spct_1 <- s_irrad_corrected(spct_1, correction.method = MAYP114590_none.mthd)
...
spct_2 <-
  s_irrad_corrected(mspct_2,
                    correction.method = MAYP114590_simple.mthd,
                    verbose = TRUE)
